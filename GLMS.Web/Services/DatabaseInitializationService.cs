...
/// <summary>
/// service responsible for initializing the database with demo data on application startup.
/// demo data generated by an LLM.
/// </summary>
                ...
                [
                    new Contract
                    {
                        ...
                        [
                            new ServiceRequest
                            {
                                Description = "Replace damaged tracking unit on delivery vehicle",
                                CostUsd = 125.00m,
                                ExchangeRate = 18.42m,
                                CostZar = 2302.50m,
                            ...
                            new ServiceRequest
                            {
                                Description = "Quarterly preventative maintenance visit",
                                CostUsd = 210.00m,
                                ExchangeRate = 18.15m,
                                CostZar = 3811.50m,
                ...
                [
                    new Contract
                    {
                        ...
                        [
                            new ServiceRequest
                            {
                                Description = "Install replacement receipt printer",
                                CostUsd = 95.00m,
                                ExchangeRate = 18.33m,
                                CostZar = 1741.35m,
                                Status = ServiceRequestStatus.Completed,
                ...
                [
                    new Contract
                    {
                        ...
                        [
                            new ServiceRequest
                            {
                                Description = "Legacy sensor calibration request",
                                CostUsd = 70.00m,
                                ExchangeRate = 18.08m,
                                CostZar = 1265.60m,
                                Status = ServiceRequestStatus.Invalid,
                                CreatedAt = today.AddDays(-41)
                            }
                        ]
                    }
                ]
